        ...
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
            <form class="space-y-4 md:space-y-6" wire:submit.prevent='login()'>
                ...
                <div>
                    ...
                    <input type="password" wire:model='password' placeholder="••••••••" class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-red-600 focus:border-red-600 block w-full p-2.5  " required="">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-start">
                        ...
                        <div class="ml-3 text-sm">
                          <label for="remember" class="text-gray-500">{{ __("Souviens-toi de moi") }}</label>
                        </div>
                    </div>
                    <a href="{{ route('forgot') }}" class="text-sm font-medium text-red-600 hover:underline">{{ __("Mot de passe oublié ?") }}</a>
                </div>
                ...
                <div class="mt-5">
                    <a href="{{ route('user.register') }}" class="text-sm font-medium text-red-600 hover:underline">
