<div>
    <div class="my-4 items-end justify-between space-y-4 md:flex sm:space-y-0 md:mb-8">
        ...
        <div class="sm:hidden block">
          <form class="flex w-full" action="{{ route("search") }}">   
              ...
              <div class="relative w-full">
                  ...
                  <input type="text" name="q" id="simple-search" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full ps-10 p-2.5 " placeholder="{{__("Recherche...")}}" required />
              </div>
