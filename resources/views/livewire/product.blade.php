        ...
        <div class="pro-detail w-full max-lg:max-w-[608px] lg:pl-8 xl:pl-16 max-lg:mx-auto max-lg:mt-8">
            ...
            <ul class="flex flex-wrap gap-2 mb-4 max-w-sm">
                ...
                <li class="color-box group text-center me-3">
                    <input type="radio" value="{{ $color->id }}" id="color-{{ $color->id }}" name="hosting"
                        wire:model="color" class="hidden peer" required />
            ...
            <ul class="flex flex-wrap w-full gap-3">
                ...
                <li>
                    <input wire:model.change="height" type="radio" id="height-{{ $item }}" value="{{ $item }}"
                        name="height" class="hidden peer" />
                    <label for="height-{{ $item }}"
                        class="inline-flex items-center justify-between p-2 px-3 text-gray-500 bg-white border-gray-200 rounded-lg cursor-pointer border-2 peer-checked:border-blue-600 peer-checked:text-blue-600 hover:text-gray-600 hover:bg-gray-100">
                        <div class="block">
