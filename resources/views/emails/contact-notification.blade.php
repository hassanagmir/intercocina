    ...
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="100%" style="max-width: 600px; margin: auto; background-color: #ffffff; box-shadow: 0 0 10px rgba(0,0,0,0.1);">
        ...
        <tr>
            <td style="padding: 40px 30px;">
                <h1 style="color: #333333; font-size: 24px; margin-bottom: 20px;">Nouvelle Message Reçu</h1>
                <p style="color: #666666; font-size: 16px; margin-bottom: 30px;">{{ $contact_message }}</p>
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center">
                    <tr>
                        <td style="border-radius: 4px; background-color: #D32F2F; text-align: center; padding: 15px 30px;">
                            <a href="{{ config('app.url') }}/admin/contacts" style="color: #ffffff; text-decoration: none; font-weight: bold; display: inline-block;">Voir les Détails du Message</a>
                        </td>
                    </tr>
                </table>
            </td>
