                    ...
                    <div class="rounded-lg border border-gray-200 bg-white p-4 shadow-sm md:p-6">
                        <div class="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                            ...
                            <a href="{{ route('product.show', $item->product->slug) }}" class="shrink-0 md:order-1">
                                <img class="h-20 w-20 dark:hidden" src="{{ Storage::url($item->product->image) }}" alt="{{ $item->product->name }}">
                            </a>
                            <!-- Quantity control -->
              ...
              <div class="space-y-4 rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:p-6">
                ...
                <div class="space-y-4">
                  <div class="space-y-6">
                    ...
                    <dl class="flex items-center justify-between gap-4">
                      <dt class="text-base font-normal text-gray-500 dark:text-gray-400">{{ _("Date")}}</dt>
                      <dd class="text-base font-bold text-gray-900">{{ $this->record->created_at->format('M d Y - H:i')}}</dd>
                    </dl>
          
                    <dl class="flex items-center justify-between gap-4">
                      <dt class="text-base font-normal text-gray-500 dark:text-gray-400">{{ __("Etat") }}</dt>
              ...
              <div class="space-y-4 rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:p-6">
                ...
                <div class="space-y-4 mt-3">
                  <div class="space-y-6">
                    ...
                    <dl class="flex items-center justify-between gap-4">
                      <dt class="text-base font-normal text-gray-500 dark:text-gray-400">{{ _("Ville")}}</dt>
