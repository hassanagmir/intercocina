...
<div x-data="{showModal: true}">
    <div 
        ...
        class="fixed inset-0 z-50 flex items-center justify-center p-4 lg:p-8 mt-16" 
        role="dialog" 
        aria-modal="true" 
    ...
    >
        ...
        >
            ...
            <button 
                ...
                class="absolute right-6 top-6 flex items-center justify-center rounded-full bg-neutral-50 p-1.5 text-neutral-900 hover:opacity-75 active:opacity-100 dark:bg-neutral-900 dark:text-white" 
