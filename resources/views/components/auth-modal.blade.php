        ...
        <section @click.away="modalOpen = false"
            ...
            <div class="relative z-10 grid gap-4 px-4 md:grid-cols-2 md:gap-16 md:px-10 md:max-w-6xl md:mx-auto">
                <div class="pb-16 space-y-6">
                    <img class="w-52 bg-white rounded-xl p-5" loading="lazy" src="/assets/imgs/intercocina-logo.png" width="208px" height="auto" alt="Login to you intercocina account" title="Login to you intercocina account" />
