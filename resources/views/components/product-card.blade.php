<div class="rounded-xl border border-gray-200 bg-white shadow-sm">
    ...
    <div class="mt-4 px-5 pb-5">
      ...
      <a href="#" class="flex items-center justify-center rounded-md bg-red-500 px-5 py-2.5 text-center text-sm font-bold text-white hover:bg-red-400 focus:outline-none focus:ring-4 focus:ring-blue-300">
