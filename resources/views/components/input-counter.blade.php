<div x-data="{ quantity: 1 }"  class="flex items-center justify-center border border-gray-400 rounded-full">
    ...
    <input type="text" placeholder="0" x-modelable="quantity" x-model="quantity" class="font-semibold text-gray-900 text-lg py-3 px-2 w-full min-[400px]:min-w-[75px] h-full bg-transparent placeholder:text-gray-900 text-center hover:text-red-600 outline-0 hover:placeholder:text-red-600">
