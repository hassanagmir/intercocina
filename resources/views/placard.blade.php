...
<div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8 rounded-xl" style="background-image: url('https://www.centimetre.com/medias/public/header/placard/ill-header-PLACARD_categorie.jpg?f2ff7e6')">
    <div class="grid md:grid-cols-2 gap-8">
        ...
        <div class="space-y-8 bg-gray-50 p-4 rounded-sm">
            ...
            <div class="grid grid-cols-2 gap-4">
                <a href="{{ route('contact') }}" class="w-full py-3 px-6 btn btn-accent-gray animate__animated animate__fadeInUp flex items-center justify-center gap-2 transition-colors">
                    {{ __("Contactez-nous") }}
                </a>
