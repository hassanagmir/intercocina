...
<div class="relative z-10 mx-auto px-6 pt-28 md:max-w-2xl lg:max-w-5xl lg:px-12">
    <div class="mx-auto text-center lg:w-4/5">
        <div class="">
            <h1 class="text-5xl font-black text-blue-950 sm:text-6xl">
                ...
                <div class="mx-auto block w-max">
                    <div class="relative block pb-2">
                        <span class="absolute inset-0 z-[1] block bg-gradient-to-b from-blue-950 via-blue-950 to-transparent bg-clip-text text-transparent">Templates</span>
            ...
            <p class="relative z-[11] my-8 text-lg text-gray-700">High Page Speed - Accessible - Fully Responsive</p>
            <div class="flex items-center justify-center gap-6">
                ...
                <a href="/affiliates" class="group flex items-center gap-1 tracking-wide text-primary">
